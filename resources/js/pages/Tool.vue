<template>
  <div>
    <Head title="Laravel Nova Events Nested Categories" />

    <Heading class="mb-6">Laravel Nova Events Nested Categories</Heading>
    ...
    >
      ...
      <p class="dark:text-white text-lg opacity-70">
        ...
        >
          /nova-components/LaravelNovaEventsNestedCategories/resources/js/pages/Tool.vue
        </code>
      </p>
    </Card>
  </div>
